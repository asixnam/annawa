<template>
  <div class="max-w-4xl mx-auto pb-12 text-left">
    ...
    <div v-else class="bg-white rounded-0 shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="p-8 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
              ...
              <div class="w-full px-4 border border-gray-200 rounded-2xl bg-gray-50/50 font-medium text-gray-800 flex items-center h-[52px] shadow-sm">
                <span class="capitalize">{{ student.gender || student.jenisKelamin || student.jk || '-' }}</span>
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="w-full px-4 border border-gray-200 rounded-2xl bg-gray-50/50 font-medium text-gray-800 flex items-center h-[52px] shadow-sm">
                <span>{{ student.child_order || student.anakKe || '-' }}</span>
              </div>
            </div>
