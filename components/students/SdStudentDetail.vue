        ...
        <div class="p-8 space-y-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div v-for="file in filesList" :key="file.key" class="space-y-2">
              ...
              <div @click="openPreview(file.label, student.files?.[file.key])" class="w-full px-4 py-4 bg-gray-50/50 border border-gray-200 rounded-2xl flex items-center justify-between group hover:border-blue-500 hover:bg-blue-50/30 transition-all cursor-pointer">
                <div class="flex items-center gap-3 min-w-0">
                  <div class="h-8 w-8 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-gray-400 group-hover:text-blue-500 transition-colors shadow-sm shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div v-if="student.files?.[file.key]" class="text-blue-600">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="bg-white rounded-[2rem] w-full max-w-4xl max-h-full overflow-hidden shadow-2xl flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto p-8 bg-gray-100/30 flex items-center justify-center min-h-[400px]">
           <div class="text-center p-12 bg-white rounded-3xl shadow-sm border border-gray-100 max-w-sm">
              <div class="h-16 w-16 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-500 mx-auto mb-4">
