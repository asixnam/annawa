          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-3">
              <label class="text-sm font-bold text-gray-700 flex items-center gap-2">
                Scan/Foto Ijazah TK/RA
              </label>
              
              <div v-if="initialData.files?.ijazahTk && !form.files.ijazahTk" class="p-3 bg-brand-50 rounded-xl border border-brand-100 flex items-center justify-between group">
              ...
              <div class="relative group">
                <input 
                  type="file" 
                  @change="handleFileUpload($event, 'ijazahTk')" 
                  accept="image/*,.pdf" 
                ...
                <div class="flex items-center gap-3 px-4 py-3 rounded-xl border-2 border-dashed border-gray-200 group-hover:border-brand-500 group-hover:bg-brand-50 transition-all duration-300">
                  ...
                  <div class="min-w-0">
                    <p class="text-[11px] font-bold text-gray-500 group-hover:text-brand-700 truncate">
                      {{ form.files.ijazahTk ? form.files.ijazahTk.name : 'Pilih file atau drag klini' }}
                    </p>
                  </div>
                </div>
              </div>
