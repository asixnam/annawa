<template>
  <div>
    <h1 class="text-3xl font-bold text-gray-900 mb-2">Dashboard SDQTA</h1>
    <p class="text-gray-500 mb-8">Kelola pendaftaran santri baru untuk unit SDQTA.</p>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="reg in registrations" :key="reg.id" class="hover:bg-gray-50 transition-colors">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
               ...
               <NuxtLink :to="`/admin/sdqta/students/${reg.id}/detail`" class="text-gray-400 hover:text-gray-600 font-bold">Detail</NuxtLink>
            </td>
          </tr>
        </tbody>
      </table>
