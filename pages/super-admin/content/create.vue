<template>
  <div class="max-w-4xl mx-auto">
    <div class="mb-6">
      <NuxtLink to="/super-admin/content" class="text-gray-500 hover:text-gray-700 text-sm mb-2 inline-block">&larr; Kembali ke Daftar Konten</NuxtLink>
      <h1 class="text-2xl font-bold text-gray-900">Buat Konten Baru</h1>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
      <form @submit.prevent="saveContent" class="space-y-6">
        ...
        <div>
          ...
          <textarea rows="15" v-model="form.content" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm leading-relaxed" placeholder="Tulis konten di sini..."></textarea>
        </div>
        ...
        <div class="pt-4 border-t border-gray-100 flex justify-end gap-3">
          ...
          <button type="submit" class="px-6 py-2.5 bg-brand-600 text-white font-bold rounded-lg hover:bg-brand-700 transition shadow-lg shadow-brand-500/20">Publikasi Konten</button>
        </div>
      </form>
    </div>
  </div>
