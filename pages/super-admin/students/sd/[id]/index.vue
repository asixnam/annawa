<template>
  ...
  >
    <template #back-link>
      <NuxtLink to="/super-admin/students/sd" class="h-10 w-10 rounded-xl bg-white border border-gray-200 flex items-center justify-center text-gray-400 hover:text-brand-600 hover:border-brand-100 hover:bg-brand-50 transition-all group shadow-sm mb-4" title="Kembali ke Daftar Murid SD">
