  ...
  <div class="max-w-4xl mx-auto pb-12">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
      <div>
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Detail Murid SDQTA</h1>
        <p class="text-gray-500 mt-2">Pratinjau lengkap profil dan berkas murid SD Qur'an Terpadu An-Nawa.</p>
      </div>
      <div class="flex gap-3">
        ...
        <NuxtLink :to="`/super-admin/students/sd/${route.params.id}`" class="px-6 py-3 bg-brand-600 text-black font-black text-sm rounded-2xl hover:bg-brand-700 transition-all shadow-xl shadow-brand-500/20 active:scale-95 flex items-center gap-2 uppercase tracking-widest text-[10px]">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="divide-y divide-gray-100">
        ...
        <div class="p-8 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Nama Lengkap -->
            <div class="space-y-2">
              <label class="text-sm font-bold text-gray-700 uppercase tracking-tighter">Nama Lengkap Murid</label>
            ...
            <!-- NIK -->
            <div class="space-y-2">
              <label class="text-sm font-bold text-gray-700 uppercase tracking-tighter">NIK Murid</label>
              <div class="w-full px-4 border border-gray-200 rounded-2xl bg-gray-50/50 font-medium text-gray-800 flex items-center h-[52px] shadow-sm">
            ...
            <div class="space-y-2 md:col-span-2">
              <label class="text-sm font-bold text-gray-700 uppercase tracking-tighter">Alamat Tempat Tinggal</label>
