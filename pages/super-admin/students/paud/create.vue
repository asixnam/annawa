<template>
  <div class="max-w-4xl mx-auto pb-12">
    <div class="mb-8">
      ...
      <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Murid Baru (PAUD)</h1>
...
function onSuccess(formData: any) {
  console.log('Successfully saved PAUD Student via component:', formData)
