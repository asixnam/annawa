        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-100">
            <tr v-for="student in filteredStudents" :key="student.id" class="hover:bg-gray-50/50 transition">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 font-medium">{{ student.nik }}</td>
              <td class="px-6 py-4 whitespace-nowrap">
                <span class="px-2.5 py-1 rounded-lg text-xs font-bold capitalize" :class="student.jk === 'laki-laki' ? 'bg-blue-50 text-blue-700' : 'bg-pink-50 text-pink-700'">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                <div class="flex justify-end gap-3 font-bold">
                  <NuxtLink :to="'/super-admin/students/paud/' + student.id + '/detail'" class="text-gray-400 hover:text-brand-600 transition-colors">Detail</NuxtLink>
                  <NuxtLink :to="'/super-admin/students/paud/' + student.id" class="text-brand-600 hover:text-brand-900 transition-colors">Edit</NuxtLink>
