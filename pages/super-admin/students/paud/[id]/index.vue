<template>
  ...
  >
    <template #back-link>
      <NuxtLink to="/super-admin/students/paud" class="h-10 w-10 rounded-xl bg-white border border-gray-200 flex items-center justify-center text-gray-400 hover:text-brand-600 hover:border-brand-100 hover:bg-brand-50 transition-all group shadow-sm mb-4" title="Kembali ke Daftar Murid PAUD">
    ...
    <template #actions>
      <button @click="deleteStudent" class="h-11 w-11 rounded-xl bg-red-50 border border-red-100 flex items-center justify-center text-red-500 hover:bg-red-500 hover:text-white hover:border-red-500 transition-all shadow-sm group" title="Hapus Murid Secara Permanen">
