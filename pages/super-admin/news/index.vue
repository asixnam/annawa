<template>
  <div>
    <div class="flex justify-between items-center mb-6">
      ...
      <NuxtLink to="/super-admin/news/create" class="px-4 py-2 bg-brand-600 text-white rounded-lg font-bold text-sm hover:bg-brand-700 transition flex items-center shadow-lg shadow-brand-500/20">
        + Buat Berita Baru
      </NuxtLink>
    </div>
        ...
        <div class="p-6">
          ...
          <div class="flex justify-between items-center pt-4 border-t border-gray-50">
            ...
            <div class="flex space-x-2">
              <NuxtLink :to="`/super-admin/news/${item.id}`" class="text-brand-600 hover:text-brand-800 font-bold text-xs uppercase px-2 py-1 bg-brand-50 rounded">Edit</NuxtLink>
...
const contents = ref([
  ...
  { id: 2, title: 'Pembukaan Pendaftaran Santri Baru', type: 'Pengumuman', date: '2026-01-15', excerpt: 'Pendaftaran santri baru tahun ajaran 2026/2027 telah dibuka...', image: null },
])
